...
export class PerfilProtectoraComponent implements OnInit {
  ...
  constructor(private apiService: ProtectoraService, private sesiones: SesionesService) { 
    this.protectora = new Protectora(0, "Abrazo Peludo", "C/ Las Rosas 22", "", "abrazo-peludo@gmail.com", "","910.000.000",'No podría existir sin la ayuda de las casas de acogidas y guarderías privadas, \
    que ofrecen un hogar temporal a muchos de nuestros animales, hasta que les encontremos un adoptante definitivo.\ En la mayoría de los casos, en ellas viven nuestros cachorros, perros de tamaño pequeño/mediano, todos los gatos y otras especies de compañía. \
